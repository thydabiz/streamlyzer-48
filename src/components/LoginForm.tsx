...
export function LoginForm({ onLoginSuccess }: LoginFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Authentication successful, syncing channels...');
      ...
      console.log(`Channel sync complete. Found ${channelCount} channels`);
      
      if (channelCount === 0) {
        throw new Error('No channels were found. Please check your credentials and try again.');
      }
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Enter your IPTV provider details
          </p>
        </div>
